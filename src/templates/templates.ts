...
import ATOM from "../languages/unit-vis";
...
export const ListFactory: WidgetFactoryFunc = (idx) =>
  ...
  } as unknown) as Widget<ListWidget>);
...
export const widgetFactoryByGroups: {
  [type: string]: { [x: string]: WidgetFactoryFunc };
} = {
  "Data Widgets": {
    DataTarget: DataTargetFactory,
    MultiDataTarget: MultiDataTargetFactory,
